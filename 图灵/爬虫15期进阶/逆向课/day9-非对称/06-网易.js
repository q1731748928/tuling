...
var bse7X = function (cxX3x) {
    var m7f = [];
    j7c.bh7a(cxX3x, function (cxW3x) {
        m7f.push(Qu7n.emj[cxW3x])
    });
    return m7f.join("")
};
