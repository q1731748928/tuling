        ...
        r = {
                ...
                (t.exports = function e(t, n) {
                    ...
                    function r(t) {
                        if ("string" != typeof t) {
                            ...
                            n = "return " + n,
                            t) {
                                for (var a = Object.keys(t), s = Array(a.length + 1), c = Array(a.length), l = 0; l < a.length; )
                                    s[l] = a[l],
                                    c[l] = t[a[l++]];
                                return s[l] = n,
            ...
            6: [function(e, t, n) {
                function o(e) {
                    ...
                    e.readDoubleLE = m ? C : b,
                    e.readDoubleBE = m ? b : C) : (e.writeDoubleLE = v.bind(null, r, 0, 4),
            ...
            11: [function(e, t, n) {
                ...
                n.toObject = function(e) {
                    ...
                    for (var n = r.codegen(["m", "o"], e.name + "$toObject")("if(!o)")("o={}")("var d={}"), i = [], s = [], c = [], l = 0; l < t.length; ++l)
                        t[l].partOf || (t[l].resolve().repeated ? i : t[l].map ? s : c).push(t[l]);
                    if (i.length) {
            ...
            12: [function(e, t, n) {
                t.exports = function(e) {
                    ...
                    n = 0; n < e.i.length; ++n) {
                        var l = e.i[n];
                        l.required && t("if(!m.hasOwnProperty(%j))", l.name)("throw util.ProtocolError(%j,{instance:m})", "missing required '" + l.name + "'")
                    }
                    return t("return m")
                }
                ;
            ...
            13: [function(e, t, n) {
                t.exports = function(e) {
                    for (var t, n = i.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), s = e.fieldsArray.slice().sort(i.compareFieldsById), c = 0; c < s.length; ++c) {
                        var l = s[c].resolve()
                          , u = e.i.indexOf(l)
                          , d = l.resolvedType instanceof o ? "int32" : l.type
                          , f = r.basic[d];
                        t = "m" + i.safeProp(l.name),
                        l.map ? (n("if(%s!=null&&Object.hasOwnProperty.call(m,%j)){", t, l.name)("for(var ks=Object.keys(%s),i=0;i<ks.length;++i){", t)("w.uint32(%i).fork().uint32(%i).%s(ks[i])", (l.id << 3 | 2) >>> 0, 8 | r.mapKey[l.keyType], l.keyType),
                        f === g ? n("types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()", u, t) : n(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | f, d, t),
                        n("}")("}")) : l.repeated ? (n("if(%s!=null&&%s.length){", t, t),
                        l.packed && r.packed[d] !== g ? n("w.uint32(%i).fork()", (l.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", t)("w.%s(%s[i])", d, t)("w.ldelim()") : (n("for(var i=0;i<%s.length;++i)", t),
                        f === g ? a(n, l, u, t + "[i]") : n("w.uint32(%i).%s(%s[i])", (l.id << 3 | f) >>> 0, d, t)),
                        n("}")) : (l.optional && n("if(%s!=null&&Object.hasOwnProperty.call(m,%j))", t, l.name),
                        f === g ? a(n, l, u, t) : n("w.uint32(%i).%s(%s)", (l.id << 3 | f) >>> 0, d, t))
                    }
                    return n("return w")
                }
                ;
            ...
            15: [function(e, t, n) {
                t.exports = l;
                var o = e(22);
                ((l.prototype = Object.create(o.prototype)).constructor = l).className = "Field";
                var r, i = e(14), a = e(32), s = e(33), c = /^required|optional|repeated$/;
                function l(e, t, n, r, i, l, u) {
                    if (s.isObject(r) ? (u = i,
                    l = r,
                    r = i = g) : s.isObject(i) && (u = l,
                    l = i,
                    i = g),
                    o.call(this, e, l),
                    !s.isInteger(t) || t < 0)
                ...
                l.prototype.setOption = function(e, t, n) {
            ...
            21: [function(e, t, n) {
                ...
                u.prototype.toJSON = function(e) {
                    return c.toObject(["options", this.options, "nested", l(this.nestedArray, e)])
                }
                ,
                u.prototype.addJSON = function(e) {
                    if (e)
                        for (var t, n = Object.keys(e), o = 0; o < n.length; ++o)
                            t = e[n[o]],
                            this.add((t.fields !== g ? r : t.values !== g ? a : t.methods !== g ? i : t.id !== g ? s : u).fromJSON(n[o], t));
                    return this
                }
                ,
                ...
                u.prototype.add = function(e) {
                    if (!(e instanceof s && e.extend !== g || e instanceof r || e instanceof a || e instanceof i || e instanceof u))
                        throw TypeError("object must be a valid nested object");
                    if (this.nested) {
                        var t = this.get(e.name);
                        if (t) {
                            if (!(t instanceof u && e instanceof u) || t instanceof r || t instanceof i)
                    ...
                    if (o) {
                        if (1 === e.length) {
                            if (!t || ~t.indexOf(o.constructor))
                                return o
                        } else if (o instanceof u && (o = o.lookup(e.slice(1), t, !0)))
                            return o
                    } else
                        for (var r = 0; r < this.nestedArray.length; ++r)
                            if (this.e[r]instanceof u && (o = this.e[r].lookup(e, t, !0)))
                                return o;
            ...
            24: [function(e, t, n) {
                ...
                var u, d = "undefined" != typeof Uint8Array ? function(e) {
            ...
            26: [function(e, t, n) {
                ...
                var r, i, a, s = e(15), c = e(14), l = e(23), u = e(33);
                function d(e) {
                    o.call(this, "", e),
                    this.deferred = [],
                    this.files = []
                ...
                d.prototype.load = function e(t, n, o) {
                    ...
                    function d(e, t) {
                        try {
                            if (u.isString(t) && "{" == (t[0] || "") && (t = JSON.parse(t)),
                            u.isString(t)) {
                                i.filename = e;
                                var o, a = i(t, r, n), d = 0;
                                if (a.imports)
                                    for (; d < a.imports.length; ++d)
                                        (o = l(a.imports[d]) || r.resolvePath(e, a.imports[d])) && p(o);
                                if (a.weakImports)
                                    for (d = 0; d < a.weakImports.length; ++d)
                                        (o = l(a.weakImports[d]) || r.resolvePath(e, a.weakImports[d])) && p(o, !0)
                            } else
            ...
            31: [function(e, t, n) {
                ...
                y.fromJSON = function(e, t) {
                    ...
                    for (var l = Object.keys(t.fields), u = 0; u < l.length; ++u)
                        n.add((void 0 !== t.fields[l[u]].keyType ? s : a).fromJSON(l[u], t.fields[l[u]]));
                    if (t.oneofs)
                        for (l = Object.keys(t.oneofs),
                        u = 0; u < l.length; ++u)
                            n.add(i.fromJSON(l[u], t.oneofs[l[u]]));
                    if (t.nested)
                        for (l = Object.keys(t.nested),
                        u = 0; u < l.length; ++u) {
                            var d = t.nested[l[u]];
                            n.add((d.id !== g ? a : d.fields !== g ? y : d.values !== g ? r : d.methods !== g ? c : o).fromJSON(l[u], d))
                        }
                ...
                y.prototype.add = function(e) {
                    ...
                    C(this)) : o.prototype.add.call(this, e)
                }
                ,
            ...
            36: [function(e, t, n) {
                t.exports = function(e) {
                    ...
                    for (var o = 0; o < e.fieldsArray.length; ++o) {
                        var s, c = e.i[o].resolve(), l = "m" + r.safeProp(c.name);
                        c.optional && t("if(%s!=null&&m.hasOwnProperty(%j)){", l, c.name),
                        c.map ? (t("if(!util.isObject(%s))", l)("return%j", i(c, "object"))("var k=Object.keys(%s)", l)("for(var i=0;i<k.length;++i){"),
                        function(e, t, n) {
                            switch (t.keyType) {
                            case "int32":
                            case "uint32":
                        ...
                        a(t, c, o, l + "[k[i]]")("}")) : c.repeated ? (t("if(!Array.isArray(%s))", l)("return%j", i(c, "array"))("for(var i=0;i<%s.length;++i){", l),
                        a(t, c, o, l + "[i]")("}")) : (c.partOf && (s = r.safeProp(c.partOf.name),
...
function PolicyInfoByTypeIdParam(m) {
     w = xl.Writer.create()
     // w = Writer.create()
...
function get_data(data){
    return PolicyInfoByTypeIdParam(data).finish().slice()
}


// console.log(get_data(data));
// console.log(PolicyInfoByTypeIdParam(data).finish().slice())


// console.log(xl.Writer.create());
