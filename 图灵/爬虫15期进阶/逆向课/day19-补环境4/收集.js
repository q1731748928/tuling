...
let getDescriptor = function getDescriptor(obj,prop,objName,protoName,instanceObj) {
 ...
 // https://blog.csdn.net/liberty888/article/details/132335253


//getProtoEnvCode(Window);
//getObjEnvCode(window,"window")
//getObjEnvCode(location,"location")
//getObjEnvCode(Navigator.prototype,"Navigator")
// getObjEnvCode(Document.prototype,document)
