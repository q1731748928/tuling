...
document.cookie = 'a1=187030acfd8mxkmdmrub605b6birew8pm7qkvplkb50000225980;';
...
(function () {
        function Shanks() {
            ...
            return function (window, _garp_d0ad1, _garp_8d381) {
                var _garp_2450a = []
                    , _garp_bb090 = []
                    , _garp_11791 = {}
                    , _garp_4139 = []
                ...
                var _garp_bad21 = [_garp_8d381, function _garp_b6c6(_garp_37ed4) {
                    ...
                    , function (_garp_37ed4) {
                        return _garp_27860(_garp_33d28, window, _garp_d0ad1.d[_garp_37ed4], _garp_a0c6d);
                    }
                    , function (_garp_37ed4) {
                ...
                var _garp_55a65 = [function (p0, p1, p2, p3, p4, p5, p6) {
                    ...
                    , function (p0, p1, p2, p3, p4, p5, p6) {
                        ...
                        _garp_6ab4(_garp_6e472.apply(typeof _garp_7b69a._garp_cc54b == "undefined" ? window : _garp_7b69a._garp_cc54b, _garp_98eec), _garp_8d381, _garp_8d381, 0);
                        return ++p4;
                    }
                    , function (p0, p1, p2, p3, p4, p5, p6) {
                        _garp_6ab4(_garp_73234(p0, p1) && _garp_73234(p2, p3), _garp_8d381, _garp_8d381, 0);
                    ...
                    , function (p0, p1, p2, p3, p4, p5, p6) {
                        ...
                        if (_garp_a3d40 && _garp_a3d40.length === 32) {
                            console.log(p2, p3, _garp_a3d40)
                        }
                        if (_garp_a3d40 && typeof _garp_a3d40 === "object" && _garp_a3d40.hasOwnProperty('signVersion')) {
                            _garp_a3d40["signVersion"] = "1"
                        }
                        if (_garp_7b69a._garp_8b4 === "_webmsxyw") {
                            _garp_7b69a._garp_cc54b = window;
                            console.log(_garp_7b69a)
                            _garp_6ab4(window[_garp_7b69a._garp_8b4] = _garp_a3d40, _garp_8d381, _garp_8d381, 0);
...
//     }
// }
// console.log(window._webmsxyw(u, i));
// globalMy.console.log(window._webmsxyw(u, i));
function main123(path,i) {
    arguments={
    "0": "/api/sns/web/v1/homefeed",
    "1": {
        "cursor_score": "",
    ...
    return window._webmsxyw(arguments)
}

// console.log(main123(u, i));
