...
response = session.get('http://www.sgcc.com.cn/html/sgcc/col2022121225/column_2022121225_9.shtml', headers=headers)
...
response = session.get('http://www.sgcc.com.cn/html/sgcc/col2022121225/column_2022121225_9.shtml', headers=headers, cookies=cookies)
