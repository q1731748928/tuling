...
function(n) {
    ...
    function h(n) {
        ...
        for (t = 0; t < n.length; t += 1)
            r = n.charCodeAt(t),
            u += o.charAt(r >>> 4 & 15) + o.charAt(15 & r);
        return u
    }
    ...
    function d(n, r) {
        return function(n, r) {
            var t, o, u = a(n), e = [], c = [];
            for (e[15] = c[15] = void 0,
            16 < u.length && (u = f(u, 8 * n.length)),
            t = 0; t < 16; t += 1)
                e[t] = 909522486 ^ u[t],
                c[t] = 1549556828 ^ u[t];
            return o = f(e.concat(a(r)), 512 + 8 * r.length),
            i(f(c.concat(o), 640))
        }(g(n), g(r))
    }
...
function get_sign(pageNumber, timestamp) {
