        ...
        r2 = {
            ...
            2: [function(e, t, n) {
                ...
                n.encode = function(e, t, n) {
                    for (var r, a = null, i = [], s = 0, l = 0; t < n; ) {
                        var u = e[t++];
                        switch (l) {
                        case 0:
                            i[s++] = o[u >> 2],
                        ...
                        8191 < s && ((a = a || []).push(String.fromCharCode.apply(String, i)),
                        s = 0)
                    }
                    return l && (i[s++] = o[r],
                    i[s++] = 61,
                    1 === l && (i[s++] = 61)),
                    a ? (s && a.push(String.fromCharCode.apply(String, i.slice(0, s))),
                    a.join("")) : String.fromCharCode.apply(String, i.slice(0, s))
                }
                ;
                var i = "invalid encoding";
                n.decode = function(e, t, n) {
                    for (var o, a = n, s = 0, l = 0; l < e.length; ) {
                ...
                (t.exports = function e(t, n) {
                    ...
                    function r(t) {
                        if ("string" != typeof t) {
                            ...
                            n = "return " + n,
                            t) {
                                for (var i = Object.keys(t), s = Array(i.length + 1), l = Array(i.length), u = 0; u < i.length; )
                                    s[u] = i[u],
                                    l[u] = t[i[u++]];
                                return s[u] = n,
            ...
            6: [function(e, t, n) {
                function o(e) {
                    ...
                    function v(e, t, n, o, r, a) {
                        ...
                        e((s << 31 | 2146435072) >>> 0, r, a + n)) : o < 22250738585072014e-324 ? (e((i = o / 5e-324) >>> 0, r, a + t),
                        e((s << 31 | i / 4294967296) >>> 0, r, a + n)) : (e(4503599627370496 * (i = o * Math.pow(2, -(o = 1024 === (o = Math.floor(Math.log(o) / Math.LN2)) ? 1023 : o))) >>> 0, r, a + t),
                        e((s << 31 | o + 1023 << 20 | 1048576 * i & 1048575) >>> 0, r, a + n))
                    }
                    ...
                    e.writeFloatLE = m ? o : l,
                    e.writeFloatBE = m ? l : o,
                    e.readFloatLE = m ? u : c,
            ...
            11: [function(e, t, n) {
                ...
                function a(e, t, n, r) {
                    if (t.resolvedType)
                        if (t.resolvedType instanceof o) {
                            e("switch(d%s){", r);
                            for (var a = t.resolvedType.values, i = Object.keys(a), s = 0; s < i.length; ++s)
                                t.repeated && a[i[s]] === t.typeDefault && e("default:"),
                                e("case%j:", i[s])("case %i:", a[i[s]])("m%s=%j", r, a[i[s]])("break");
                            e("}")
                        } else
                ...
                n.fromObject = function(e) {
                    ...
                    for (var i = 0; i < t.length; ++i) {
                        ...
                        a(n, s, i, l + "[ks[i]]")("}")("}")) : s.repeated ? (n("if(d%s){", l)("if(!Array.isArray(d%s))", l)("throw TypeError(%j)", s.fullName + ": array expected")("m%s=[]", l)("for(var i=0;i<d%s.length;++i){", l),
                        a(n, s, i, l + "[i]")("}")("}")) : (s.resolvedType instanceof o || n("if(d%s!=null){", l),
                        a(n, s, i, l),
                ...
                n.toObject = function(e) {
                    ...
                    for (var n = r.codegen(["m", "o"], e.name + "$toObject")("if(!o)")("o={}")("var d={}"), a = [], s = [], l = [], u = 0; u < t.length; ++u)
                        t[u].partOf || (t[u].resolve().repeated ? a : t[u].map ? s : l).push(t[u]);
                    if (a.length) {
                    ...
                    if (l.length) {
                        for (n("if(o.defaults){"),
                        u = 0; u < l.length; ++u) {
                            var c, d = l[u], p = r.safeProp(d.name);
            ...
            12: [function(e, t, n) {
                t.exports = function(e) {
                    ...
                    for (var n = 0; n < e.fieldsArray.length; ++n) {
                        var i = e.i[n].resolve()
                          , s = i.resolvedType instanceof o ? "int32" : i.type
                          , l = "m" + a.safeProp(i.name);
                        t("case %i:", i.id),
                        i.map ? (t("if(%s===util.emptyObject)", l)("%s={}", l)("var c2 = r.uint32()+r.pos"),
                        ...
                        r.long[i.keyType] !== g ? t('%s[typeof k==="object"?util.longToHash(k):k]=value', l) : t("%s[k]=value", l)) : i.repeated ? (t("if(!(%s&&%s.length))", l, l)("%s=[]", l),
                        r.packed[s] !== g && t("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())", l, s)("}else"),
                        r.basic[s] === g ? t(i.resolvedType.group ? "%s.push(types[%i].decode(r))" : "%s.push(types[%i].decode(r,r.uint32()))", l, n) : t("%s.push(r.%s())", l, s)) : r.basic[s] === g ? t(i.resolvedType.group ? "%s=types[%i].decode(r)" : "%s=types[%i].decode(r,r.uint32())", l, n) : t("%s=r.%s()", l, s),
                        t("break")
                    }
            ...
            13: [function(e, t, n) {
                t.exports = function(e) {
                    for (var t, n = a.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), s = e.fieldsArray.slice().sort(a.compareFieldsById), l = 0; l < s.length; ++l) {
                        var u = s[l].resolve()
                          , c = e.i.indexOf(u)
                ...
                function i(e, t, n, r, a) {
                    ...
                    t)
                        for (var i = Object.keys(t), s = 0; s < i.length; ++s)
                            "number" == typeof t[i[s]] && (this.valuesById[this.values[i[s]] = t[i[s]]] = i[s])
                }
            ...
            15: [function(e, t, n) {
                ...
                e(14)), i = e(32), s = e(33), l = /^required|optional|repeated$/;
                function u(e, t, n, o, a, u, c) {
                    if (s.isObject(o) ? (c = a,
                    u = o,
                    o = a = g) : s.isObject(a) && (c = u,
                    u = a,
                    a = g),
                    r.call(this, e, u),
                    !s.isInteger(t) || t < 0)
                    ...
                    if (o !== g && !l.test(o = o.toString().toLowerCase()))
                ...
                u.d = function(e, t, n, o) {
                    ...
                    function(r, a) {
                        s.decorateType(r.constructor).add(new u(a,e,t,n,{
                            default: o
                        }))
                    }
                }
            ...
            20: [function(e, t, n) {
                ...
                e(33));
                function a(e, t, n, a, i, s, l, u, c) {
                    if (r.isObject(i) ? (l = i,
                    i = s = g) : r.isObject(s) && (l = s,
                    s = g),
                    t !== g && !r.isString(t))
                        throw TypeError("type must be a string");
                    if (!r.isString(n))
            ...
            21: [function(e, t, n) {
                t.exports = d;
                var o, r, a, i = e(22), s = (((d.prototype = Object.create(i.prototype)).constructor = d).className = "Namespace",
                e(15)), l = e(23), u = e(33);
                function c(e, t) {
                    if (!e || !e.length)
                        return g;
                ...
                d.prototype.addJSON = function(e) {
                    if (e)
                        for (var t, n = Object.keys(e), i = 0; i < n.length; ++i)
                            t = e[n[i]],
                            this.add((t.fields !== g ? o : t.values !== g ? a : t.methods !== g ? r : t.id !== g ? s : d).fromJSON(n[i], t));
                    return this
                }
                ,
                ...
                d.prototype.add = function(e) {
                    if (!(e instanceof s && e.extend !== g || e instanceof o || e instanceof a || e instanceof r || e instanceof d || e instanceof l))
            ...
            24: [function(e, t, n) {
                ...
                l.create = u(),
                l.prototype.h = r.Array.prototype.subarray || r.Array.prototype.slice,
            ...
            26: [function(e, t, n) {
                t.exports = d;
                var o, r, a, i = e(21), s = (((d.prototype = Object.create(i.prototype)).constructor = d).className = "Root",
                e(15)), l = e(14), u = e(23), c = e(33);
                function d(e) {
                    i.call(this, "", e),
                    this.deferred = [],
                    this.files = []
                ...
                function h(e, t) {
                    ...
                    if (o)
                        return ((n = new s(t.fullName,t.id,t.type,t.rule,g,t.options)).declaringField = t).extensionField = n,
                        o.add(n),
                        1
                }
            ...
            29: [function(e, t, n) {
                ...
                ((r.prototype = Object.create(o.EventEmitter.prototype)).constructor = r).prototype.rpcCall = function e(t, n, r, a, i) {
                    ...
                    var s = this;
                    if (!i)
                        return o.asPromise(e, s, t, n, r, a);
                    if (!s.rpcImpl)
                        ...
                        g;
                    try {
                        return s.rpcImpl(t, n[s.requestDelimited ? "encodeDelimited" : "encode"](a).finish(), (function(e, n) {
                            if (e)
            ...
            30: [function(e, t, n) {
                t.exports = s;
                var o = e(21)
                  , r = (((s.prototype = Object.create(o.prototype)).constructor = s).className = "Service",
                e(20))
                  , a = e(33)
                  , i = e(28);
                function s(e, t) {
                ...
                s.prototype.add = function(e) {
                    if (this.get(e.name))
                        throw Error("duplicate name '" + e.name + "' in " + this);
                    return e instanceof r ? l((this.methods[e.name] = e).parent = this) : o.prototype.add.call(this, e)
                }
                ,
                ...
                s.prototype.create = function(e, t, n) {
                    for (var o, r = new i.Service(e,t,n), s = 0; s < this.methodsArray.length; ++s) {
                        var l = a.lcFirst((o = this.f[s]).resolve().name).replace(/[^$\w_]/g, "");
                        r[l] = a.codegen(["r", "c"], a.isReserved(l) ? l + "_" : l)("return this.rpcCall(m,q,s,r,c)")({
                            m: o,
            ...
            31: [function(e, t, n) {
                ...
                b.fromJSON = function(e, t) {
                    ...
                    Object.keys(t.fields)), c = 0; c < u.length; ++c)
                        n.add((void 0 !== t.fields[u[c]].keyType ? s : i).fromJSON(u[c], t.fields[u[c]]));
                    if (t.oneofs)
                    ...
                    if (t.nested)
                        ...
                        c = 0; c < u.length; ++c) {
                            var d = t.nested[u[c]];
                            n.add((d.id !== g ? i : d.fields !== g ? b : d.values !== g ? r : d.methods !== g ? l : o).fromJSON(u[c], d))
                        }
            ...
            33: [function(e, t, n) {
                var o, r, a = t.exports = e(35), i = e(27), s = (a.codegen = e(3),
                a.fetch = e(5),
                a.path = e(8),
                a.fs = a.inquire("fs"),
            ...
            36: [function(e, t, n) {
                t.exports = function(e) {
                    ...
                    for (var o = 0; o < e.fieldsArray.length; ++o) {
                        var s, l = e.i[o].resolve(), u = "m" + r.safeProp(l.name);
                        l.optional && t("if(%s!=null&&m.hasOwnProperty(%j)){", u, l.name),
                        l.map ? (t("if(!util.isObject(%s))", u)("return%j", a(l, "object"))("var k=Object.keys(%s)", u)("for(var i=0;i<k.length;++i){"),
                        function(e, t, n) {
                            switch (t.keyType) {
                            case "int32":
                            case "uint32":
                        ...
                        i(t, l, o, u + "[k[i]]")("}")) : l.repeated ? (t("if(!Array.isArray(%s))", u)("return%j", a(l, "array"))("for(var i=0;i<%s.length;++i){", u),
                        i(t, l, o, u + "[i]")("}")) : (l.partOf && (s = r.safeProp(l.partOf.name),
                        1 === n[l.partOf.name] && t("if(p%s===1)", s)("return%j", l.partOf.name + ": multiple values"),
                        n[l.partOf.name] = 1,
                        t("p%s=1", s)),
                        i(t, l, o, u)),
                        l.optional && t("}")
                ...
                function i(e, t, n, r) {
                    if (t.resolvedType)
                        if (t.resolvedType instanceof o) {
                            ...
                            for (var i = Object.keys(t.resolvedType.values), s = 0; s < i.length; ++s)
                                e("case %i:", t.resolvedType.values[i[s]]);
                            e("break")("}")
                        } else
            ...
            38: [function(e, t, n) {
                t.exports = d;
                var o, r = e(35), a = r.LongBits, i = r.base64, s = r.utf8;
                function l(e, t, n) {
                    this.fn = e,
                    this.len = t,
                    this.next = g,
                ...
                ,
                (h.prototype = Object.create(l.prototype)).fn = function(e, t, n) {
                    for (; 127 < e; )
                        t[n++] = 127 & e | 128,
                        e >>>= 7;
                    t[n] = e
                ...
                d.prototype.string = function(e) {
                    var t = s.length(e);
                    return t ? this.uint32(t).p(s.write, t, e) : this.p(f, 1, 0)
                }
                ,
...
// r[l(269, "WM9F", 613, 208)] = d[l(-225, "6!hZ", -179, -198) + "e"](r[u("Py%I", 1391, 1138, 1596, 1571)])[u("H*^W", 2191, 1549, 1882, 1736) + "h"]()[l(289, "6!hZ", -295, 114)]()

function get_data(m) {
    return PolicyInfoByTypeIdParam$encode(m).finish().slice()
}
m = {
    "policyType": "6",
    "province": "",
...
console.log(get_data(m));

// <Buffer 0a 01 36 12 00 1a 00 22 00 2a 00 32 00 38 00 40 01 48 07>
// <Buffer 0a 01 36 12 00 1a 00 22 00 2a 00 32 00 38 00 40 01 48 07>